...
namespace LaserDynamics.Calculations.FMBSsfmLaserModel
{
    ...
    public class Ssfm1dView : ICalculationView
    {
        ...
        string _title = "Maxvell-Block Transverse dynamic (1d) SSFM";
        ...
        static string[] _initialConditions = new string[3] { "Around homogeneous solution", "Around trivial solution", "Small-amplitude white Noise" };
        ...
        [DisplayTitle("Начальное условие", DataType.Discrete, "Условия", "", new string[3] { "Around homogeneous solution", "Around trivial solution", "Small-amplitude white Noise" })]
