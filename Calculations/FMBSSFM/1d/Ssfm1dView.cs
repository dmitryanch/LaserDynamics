...
namespace LaserDynamics.Calculations.FMBSsfmLaserModel
{
    ...
    public class Ssfm1dView : ICalculationView
    {
        ...
        static string[] _initialConditions = new string[] { "Around homogeneous solution", "Around trivial solution", "Small-amplitude white Noise" };
        ...
        [DisplayTitle("Начальное условие", DataType.Discrete, "Условия", "", new string[] { "Around homogeneous solution", "Around trivial solution", "Small-amplitude white Noise" })]
